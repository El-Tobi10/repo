            ...
            <div class="mb-3">
                ...
                <div class="mb-1">
                    <ul>
                        ...
                        <li class="input-group mb-2"><input type="number" name="score" class="form-control" min="1"
                                max="100" placeholder="Solo se admiten numeros desde el 1 al 100" REQUIRED>
                        </li>
            ...
            <div class="mb-3">
                ...
                <div class="mb-1">
                    <ul>
                        ...
                        <li class="input-group mb-2"><input type="url" name="steam" placeholder="Aqui va la url.."
                                data-validation="url" class="form-control"><span class="input-group-text"
                                id="basic-addon1">$</span><input type="float" name="precio_steam" class="form-control"
                                REQUIRED></li>
                        ...
                        <li class="input-group mb-2"><input type="url" name="epic" placeholder="Aqui va la url.."
                                data-validation="url" class="form-control"><span class="input-group-text"
                                id="basic-addon1">$</span><input type="float" name="precio_epic" class="form-control"
                                REQUIRED></li>
                        <label class="me-1">Xbox</label><i class="bi bi-xbox"></i>
                        <li class="input-group mb-2"><input type="url" name="xbox" placeholder="Aqui va la url.."
                                data-validation="url" class="form-control"><span class="input-group-text"
                                id="basic-addon1">$</span><input type="float" name="precio_xbox" class="form-control"
                                REQUIRED></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="mb-3">
                ...
                <input type="url" name="trailer" placeholder="Aqui va la url.." data-validation="url"
